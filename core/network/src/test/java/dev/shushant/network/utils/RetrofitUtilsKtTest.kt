...
class MyApiTest {
    ...
    @Test
    fun `safeApiCall with successful response`() = runTest {
    ...
    @Test
    fun `safeApiCall with unsuccessful response and error message`() = runTest {
    ...
    @Test
    fun `safeApiCall with empty response body`() = runTest {
    ...
    @Test
    fun `safeApiCall with exception`() = runTest {
